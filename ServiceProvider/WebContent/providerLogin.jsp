...
<html lang="en">
  <head>
    ...
    <title>Job Provider Login : Service Provider</title>
  </head>
  <body>
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarToggle">
              ...
              <div class="navbar-nav">
                  <a class="nav-item nav-link" href="providerLogin.jsp">Sign In</a>
      ...
      <div class="container">
        <div class="row no-gutters">
          ...
          <div class="col-lg-7 px-5 pt-5 pb-2">
            ...
            <p class="mt-1">
            	For Login as Job Seeker <a href="seekerLogin.jsp">click here</a>
            </p>
          </div>           
          </div>
        </div>
